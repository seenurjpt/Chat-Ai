...
function App() {
  ...
  return (
    <div className=" bg-[#1A232E] h-screen py-6 relative sm:px-16 px-2 text-white overflow-hidden flex flex-col  justify-between align-middle ">

      <div className="gradient-01 z-0 absolute" ></div>
      <div className="gradient-02 z-0 absolute" ></div>

      <div className='uppercase font-bold text-4xl text-center mb-5 mt-5 ' >
      𝖈𝖍𝖆𝖙 𝖆𝖎
      </div>
      ...
      <div className="w-full max-w-xl min-w-[20rem] self-center" >
